...
//
//        String imageUrl = clothService.uploadImage(file, "NATIVE", "TOP");
//
...
//
//
//        assertThrows(EWardRobeException.class, () -> clothService.deleteCloth(clothId));
//    }
//
//    @Test
...
//
//
//        assertThrows(UserNotFoundException.class, () -> clothService.deleteCloth(clothId));
//    }
//}
